				...
				<ul
					...
					<li class="dropdown-content">
						<ul class="dropdown-menu dropdown-navbar">
							...
							<li><a href="#" class="clearfix"> <img
									src="<c:url value='/template/admin/assets/avatars/avatar3.png' />"
							...
							<li><a href="#" class="clearfix"> <img
									src="<c:url value='/template/admin/assets/avatars/avatar2.png' />"
							...
							<li><a href="#" class="clearfix"> <img
									src="<c:url value='/template/admin/assets/avatars/avatar5.png' />"
